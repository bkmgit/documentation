...
* [3. Installation](setup/3.-installation/README.md)
  ...
  * [3.2 Set-up your own country configuration](setup/3.-installation/3.2-set-up-your-own-country-configuration/README.md)
    ...
    * [3.2.5 Set up application settings](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.5-set-up-application-settings.md)
    ...
    * [3.2.7 Configure declaration forms](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-declaration-forms.md)
    * [3.2.8 Seeding your local database](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.8-seeding-your-local-database/README.md)
      * [3.2.8.1 Clearing and restoring a local environment to factory reset data](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.8-seeding-your-local-database/3.2.8.1-clearing-and-restoring-a-local-environment-to-factory-reset-data.md)
