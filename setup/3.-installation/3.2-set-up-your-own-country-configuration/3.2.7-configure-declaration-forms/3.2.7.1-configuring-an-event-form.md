...
You can create new, custom validator functions in this file if you do not find one in core that you can use: [custom-validators.ts](https://github.com/opencrvs/opencrvs-countryconfig/blob/develop/src/form/common/custom-validation-conditionals/custom-validators.ts)
